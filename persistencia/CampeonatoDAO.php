<?php
    ...
    class CampeonatoDAO{
        ...
        public function insertar(){
            return "insert into Campeonato(nombreCampeonato, fechaInicio, fechaFin) values ('" . $this->nombreCampeonato . "', '" . $this->fechaInicio . "', '" . $this->fechaFin . "')";
        }

        public function MostrarCampeonatos(){
            return "select * from Campeonato"; 
        }
